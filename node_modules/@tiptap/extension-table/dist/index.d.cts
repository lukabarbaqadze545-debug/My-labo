import { Extension, JSONContent, MarkdownRendererHelpers, Node, ParentConfig } from "@tiptap/core";
import { DOMOutputSpec, Fragment, Node as Node$1, Schema } from "@tiptap/pm/model";
...
//#endregion
//#region src/table/utilities/createColGroup.d.ts
type ColGroup = {
...
//#endregion
//#region src/table/utilities/createTable.d.ts
...
//#endregion
//#region src/table/utilities/markdown.d.ts
 ...
 */
declare function escapeTableCellPipes(line: string): string;
/**
 ...
 */
declare function preprocessTablePipes(src: string): string;
...
//#endregion
//#region src/table/TableView.d.ts
...
//#endregion
export { ColGroup, DEFAULT_CELL_LINE_SEPARATOR, Table, TableCell, TableCellOptions, TableHeader, TableHeaderOptions, TableKit, TableKitOptions, TableOptions, TableRow, TableRowOptions, TableView, createColGroup, createTable, escapeTableCellPipes, preprocessTablePipes, renderTableToMarkdown, updateColumns };
