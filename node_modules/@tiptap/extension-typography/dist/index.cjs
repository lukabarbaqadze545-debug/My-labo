...
const emDash = (override) => (0, _tiptap_core.textInputRule)({
	find: /--$/,
	replace: override !== null && override !== void 0 ? override : "—"
});
const ellipsis = (override) => (0, _tiptap_core.textInputRule)({
	find: /\.\.\.$/,
	replace: override !== null && override !== void 0 ? override : "…"
});
const openDoubleQuote = (override) => (0, _tiptap_core.textInputRule)({
	find: /(?:^|[\s{[(<'"\u2018\u201C])(")$/,
	replace: override !== null && override !== void 0 ? override : "“"
});
const closeDoubleQuote = (override) => (0, _tiptap_core.textInputRule)({
	find: /"$/,
	replace: override !== null && override !== void 0 ? override : "”"
});
const openSingleQuote = (override) => (0, _tiptap_core.textInputRule)({
	find: /(?:^|[\s{[(<'"\u2018\u201C])(')$/,
	replace: override !== null && override !== void 0 ? override : "‘"
});
const closeSingleQuote = (override) => (0, _tiptap_core.textInputRule)({
	find: /'$/,
	replace: override !== null && override !== void 0 ? override : "’"
});
const leftArrow = (override) => (0, _tiptap_core.textInputRule)({
	find: /<-$/,
	replace: override !== null && override !== void 0 ? override : "←"
});
const rightArrow = (override) => (0, _tiptap_core.textInputRule)({
	find: /->$/,
	replace: override !== null && override !== void 0 ? override : "→"
});
const copyright = (override) => (0, _tiptap_core.textInputRule)({
	find: /\(c\)$/,
	replace: override !== null && override !== void 0 ? override : "©"
});
const trademark = (override) => (0, _tiptap_core.textInputRule)({
	find: /\(tm\)$/,
	replace: override !== null && override !== void 0 ? override : "™"
});
const servicemark = (override) => (0, _tiptap_core.textInputRule)({
	find: /\(sm\)$/,
	replace: override !== null && override !== void 0 ? override : "℠"
});
const registeredTrademark = (override) => (0, _tiptap_core.textInputRule)({
	find: /\(r\)$/,
	replace: override !== null && override !== void 0 ? override : "®"
});
const oneHalf = (override) => (0, _tiptap_core.textInputRule)({
	find: /(?:^|\s)(1\/2)\s$/,
	replace: override !== null && override !== void 0 ? override : "½"
});
const plusMinus = (override) => (0, _tiptap_core.textInputRule)({
	find: /\+\/-$/,
	replace: override !== null && override !== void 0 ? override : "±"
});
const notEqual = (override) => (0, _tiptap_core.textInputRule)({
	find: /!=$/,
	replace: override !== null && override !== void 0 ? override : "≠"
});
const laquo = (override) => (0, _tiptap_core.textInputRule)({
	find: /<<$/,
	replace: override !== null && override !== void 0 ? override : "«"
});
const raquo = (override) => (0, _tiptap_core.textInputRule)({
	find: />>$/,
	replace: override !== null && override !== void 0 ? override : "»"
});
const multiplication = (override) => (0, _tiptap_core.textInputRule)({
	find: /\d+\s?([*x])\s?\d+$/,
	replace: override !== null && override !== void 0 ? override : "×"
});
const superscriptTwo = (override) => (0, _tiptap_core.textInputRule)({
	find: /\^2$/,
	replace: override !== null && override !== void 0 ? override : "²"
});
const superscriptThree = (override) => (0, _tiptap_core.textInputRule)({
	find: /\^3$/,
	replace: override !== null && override !== void 0 ? override : "³"
});
const oneQuarter = (override) => (0, _tiptap_core.textInputRule)({
	find: /(?:^|\s)(1\/4)\s$/,
	replace: override !== null && override !== void 0 ? override : "¼"
});
const threeQuarters = (override) => (0, _tiptap_core.textInputRule)({
	find: /(?:^|\s)(3\/4)\s$/,
	replace: override !== null && override !== void 0 ? override : "¾"
});
/**
...
*/
const Typography = _tiptap_core.Extension.create({
	name: "typography",
	addOptions() {
		return {
			closeDoubleQuote: "”",
