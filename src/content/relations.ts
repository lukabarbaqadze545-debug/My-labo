...
export const RELATIONSHIPS: Relationship[] = [
  ...
  { from: 'probability-basics', to: 'conditional-probability', kind: 'leadsTo' },
  { from: 'conditional-probability', to: 'bayes-person', kind: 'discoveredBy' },
  { from: 'conditional-probability', to: 'what-is-machine-learning', kind: 'appliesTo', note: { ka: 'ბაიესისეული განახლება' } },
  { from: 'probability-basics', to: 'expected-value', kind: 'leadsTo' },
  { from: 'expected-value', to: 'distributions', kind: 'leadsTo' },
  { from: 'distributions', to: 'statistics-basics', kind: 'requires' },
  { from: 'randomness-and-fallacies', to: 'probability-basics', kind: 'requires' },
  { from: 'randomness-and-fallacies', to: 'cognitive-biases', kind: 'contrasts', note: { ka: 'ტვინი ნიმუშს ეძებს' } },
